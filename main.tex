...
La Figura~\ref{fig:confusion-binaria} presenta la matriz de confusión para la
tarea de detección binaria, donde el modelo distingue entre imágenes que
contienen algún objeto de interés (\textit{Positivo}: fauna, personas o vehículos)
e imágenes sin objeto (\textit{Negativo}: blanco). Los resultados se resumen en
la Tabla~\ref{tab:metricas-binarias}.
