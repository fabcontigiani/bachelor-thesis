...
\begin{description}
	\item[Sensor de movimiento:] Típicamente un sensor \gls{pir} que detecta
	      ...
	      ángulo y alcance, generalmente entre 10 y 20 metros.
	\item[Módulo de cámara:] Sensor de imagen \gls{cmos} con resoluciones que
	      varían desde 5 hasta 48 megapíxeles en modelos actuales. La calidad
	...
	\item[Sistema de iluminación:] Para capturas nocturnas, las cámaras incluyen
	      LEDs \gls{ir} o flash blanco. Los LEDs infrarrojos (850nm o 940nm)
	...
	\item[Almacenamiento:] Tarjetas de memoria SD o microSD, con capacidades
	      típicas de 32 a 512 GB, permitiendo almacenar miles de imágenes o
...
\begin{enumerate}
	...
	\item \textbf{Activación:} El microprocesador despierta el sistema de cámara,
	      ...
	      o tiempo de disparo, que varía entre 0.1 y 2 segundos según el modelo.
...
\begin{description}
	...
	\item[LED infrarrojo visible (850nm):] Emite un tenue resplandor rojo
	      visible para algunos animales, pero menos intrusivo que el flash
	      blanco.
	\item[LED infrarrojo invisible (940nm, ``no-glow''):] Completamente invisible
