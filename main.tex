...
\begin{itemize}
	...
	\item \textbf{Interfaz web de gestión:} panel administrativo y de monitoreo para la visualización en tiempo real de las últimas imágenes recibidas y procesadas.
\end{itemize}
