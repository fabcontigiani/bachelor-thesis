...
comunicación con la red mesh. A continuación se presenta la función principal
\texttt{app\_main()} que inicializa todos los componentes del sistema:

\inputminted[firstline=634, lastline=730, firstnumber=634]{c}{src/mesh-node-capstone-project/main/mesh_node.c}

La función \texttt{capture\_and\_save\_photo()} es responsable de capturar una
imagen, guardarla en la tarjeta SD y transmitirla a través de la red mesh:

\inputminted[firstline=419, lastline=483, firstnumber=419]{c}{src/mesh-node-capstone-project/main/mesh_node.c}
