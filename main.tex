...
\begin{table}[ht]
  ...
  \begin{tblr}{
    ...
    Costo Operativo              & Bajo        & Alto (Plan mensual)               & Muy Alto (Iridium)                  & Bajo (SMS/\allowbreak Twilio)          \\
    ...
    Dependencia de terceros      & No          & Muy Alta                          & Muy Alta                            & Media\allowbreak\ (Twilio)             \\
  \end{tblr}
\end{table}
...
\subsection{Pruebas de retroalimentación interactiva (\textit{Human-\allowbreak in-\allowbreak the-\allowbreak loop})}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=8cm, width=\textwidth, keepaspectratio]{img/nodoCampo1Lejos.jpg}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=8cm, width=\textwidth, keepaspectratio]{img/nodoCampo1.jpg}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{img/nodoCampo2Lejos.jpg}
    \caption{Vista general}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{img/nodoCampo2.jpg}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{img/nodoCampo3b.jpg}
    \caption{Vista general}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{img/nodoCampo3a.jpg}
...
\begin{description}
  ...
  \item[Ahorro de energía:] Investigar estrategias
  ...
  \item[Actualización OTA:] Implementar un mecanismo de
...
en \texttt{main.py} del repositorio \texttt{wildlife-\allowbreak detection-\allowbreak capstone-\allowbreak project}.
...
\begin{description}
  \item[DJANGO\_\allowbreak SECRET\_\allowbreak KEY:] Clave secreta de Django para producción.
  \item[POSTGRES\_\allowbreak DB, POSTGRES\_\allowbreak USER, POSTGRES\_\allowbreak PASSWORD:] Credenciales
    de la base de datos PostgreSQL.
  \item[TELEGRAM\_\allowbreak BOT\_\allowbreak TOKEN:] Token del bot de Telegram (requerido).
  \item[GUNICORN\_\allowbreak WORKERS:] Número de workers de Gunicorn (por defecto, 2).
\end{description}
...
\begin{description}
  \item[SpeciesNet no responde:] Verificar el estado del contenedor
    con \texttt{docker compose\allowbreak\ logs\allowbreak\ speciesnet}.
  ...
  \item[Bot de Telegram sin respuesta:] Verificar que el token
    ...
    los logs con \texttt{docker compose\allowbreak\ logs\allowbreak\ bot}.
  \item[Imágenes no procesadas:] Verificar que todos los servicios
    estén en ejecución con \texttt{docker compose\allowbreak\ ps}
