...
\newglossaryentry{18650}{
	...
	description={Celda de batería de iones de litio con formato cilíndrico de 18mm de diámetro y 65mm de longitud. Ampliamente utilizada en dispositivos electrónicos portátiles por su alta densidad energética y capacidad de recarga}
}
...
\newglossaryentry{corredor-verde}{
	name=Corredor Verde,
	description={Corredor biológico de aproximadamente 1.1 millones de hectáreas en la provincia de Misiones, Argentina, que conecta áreas protegidas para permitir el desplazamiento de fauna silvestre y mantener la conectividad genética de las poblaciones}
}
...
\newglossaryentry{mata-atlantica}{
	name=Mata Atlántica,
	description={Nombre en portugués del Bosque Atlántico, utilizado principalmente en Brasil donde se encuentra el 92\% de la extensión original de este bioma}
}
